...
// 🛠️ [新增] 分类父子关系映射表
// 用于本地数据库查询：当查父分类(Key)时，自动包含所有子分类(Value)
const CATEGORY_RELATIONS = {
  // 1. 电影
  // 1: [6, 7, 8, 9, 10, 11, 12, 18, 20, 34, 44, 52, 53, 62, 70, 71],
  1: [6, 7, 8, 9, 10, 11, 12, 20, 62, 70, 71],
  // 2. 电视剧
  2: [13, 14, 15, 16, 17, 18, 19, 23, 54, 64, 65, 66, 67, 68, 69, 72, 73],
  // 3. 综艺
  3: [25, 26, 27, 28, 47],
  // 4. 动漫
  4: [29, 30, 31, 39, 44, 45, 63],
  // 31. 体育 (如果体育是父类)
  31: [32, 33, 35, 48],
}
